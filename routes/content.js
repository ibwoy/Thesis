...
function ContentHandler (db) {
    ...
    // Under development, displaying pages 1,2,3..
    ...
    this.searchByTitle = function(req, res, next) {
        "use strict";
    ...
    this.handleNewPost = function(req, res, next) {
	   ...
	   //Chech if there is already a post with the same title
       posts.getPostByTitle(title, function (err, post) {
        "use sctrict";
        ...
        if (!post) //Insert the post
            ...
            // else give error
                    ...
                    var errors = "Post with title " +title+ " exists, please choose another title for your post";
                        return res.render("newpost_template", {subject:"", username:req.username, body:entry, tags:tags, errors:errors});
            }
        });
     }
} 
